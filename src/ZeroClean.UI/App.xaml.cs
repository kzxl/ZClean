...
public partial class App : Application
{
    public App()
    {
        ...
        {
            MessageBox.Show($"Application error: {e.Exception.Message}", "ZeroClean Error", MessageBoxButton.OK, MessageBoxImage.Error);
            e.Handled = true;
        };
    }
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
        ...
        {
            MessageBox.Show($"Failed to initialize ZeroUI theme: {ex.Message}", "ZeroClean Warning", MessageBoxButton.OK, MessageBoxImage.Warning);
        }
