...
public partial class App : Application
{
    public App()
    {
        ...
        {
            MessageBox.Show($"Application error: {e.Exception.Message}", "ZClean Error", MessageBoxButton.OK, MessageBoxImage.Error);
            e.Handled = true;
        };
    }
    ...
    protected override void OnStartup(StartupEventArgs e)
    {
        ...
        {
            MessageBox.Show($"Failed to initialize ZeroUI theme: {ex.Message}", "ZClean Warning", MessageBoxButton.OK, MessageBoxImage.Warning);
        }
