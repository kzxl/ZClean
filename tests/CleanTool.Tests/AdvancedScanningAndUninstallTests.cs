...
public class AdvancedScanningAndUninstallTests
{
    ...
    {
        var sandbox = Path.Combine(Path.GetTempPath(), "CleanTool_ResidualTest_" + Guid.NewGuid().ToString("N"));
    ...
    {
        var sandbox = Path.Combine(Path.GetTempPath(), "CleanTool_LargeFileTest_" + Guid.NewGuid().ToString("N"));
    ...
    {
        var sandbox = Path.Combine(Path.GetTempPath(), "CleanTool_EmptyFolderTest_" + Guid.NewGuid().ToString("N"));
