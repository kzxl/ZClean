...
public class AdvancedScanningAndUninstallTests
{
    ...
    {
        var sandbox = Path.Combine(Path.GetTempPath(), "ZClean_ResidualTest_" + Guid.NewGuid().ToString("N"));
    ...
    {
        var sandbox = Path.Combine(Path.GetTempPath(), "ZClean_LargeFileTest_" + Guid.NewGuid().ToString("N"));
    ...
    {
        var sandbox = Path.Combine(Path.GetTempPath(), "ZClean_EmptyFolderTest_" + Guid.NewGuid().ToString("N"));
    ...
    {
        var service = new AppUninstallerService();
        var sandbox = Path.Combine(Path.GetTempPath(), "ZClean_VendorSafety_" + Guid.NewGuid().ToString("N"));
    ...
    {
        var service = new AppUninstallerService();
        var sandbox = Path.Combine(Path.GetTempPath(), "ZClean_ConfidenceTest_" + Guid.NewGuid().ToString("N"));
